...
public class SubjectDetailCode {
    ...
    public void getAllDetails(int masterType) throws Exception {
        ...
        FileReader frForSubjectCode = new FileReader("D:\\apps\\java-develop\\oneonone\\common\\subjectDetail\\subjectDetailNameAndCodes-"+(masterType==1?"xs":"zs")+ ".txt");
        ...
        GetDetailTask3 t1 = new GetDetailTask3();
        t1.setMasterType(masterType);
        ...
        GetDetailTask3 t2 = new GetDetailTask3();
        t2.setMasterType(masterType);
        ...
        GetDetailTask3 t3 = new GetDetailTask3();
        t3.setMasterType(masterType);
        ...
        GetDetailTask3 t4 = new GetDetailTask3();
        t4.setMasterType(masterType);
        ...
        GetDetailTask3 t5 = new GetDetailTask3();
        t5.setMasterType(masterType);
        ...
        GetDetailTask3 t6 = new GetDetailTask3();
        t6.setMasterType(masterType);
    ...
    public void getAllDetailsForXS() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        SubjectDetailCode subjectDetailCode = new SubjectDetailCode();
        subjectDetailCode.getAllDetails(1);
        subjectDetailCode.getAllDetails(2);
    }
}
